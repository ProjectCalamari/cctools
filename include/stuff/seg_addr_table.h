...
extern struct seg_addr_table *
parse_default_seg_addr_table(char **seg_addr_table_name, uint32_t *table_size);

extern struct seg_addr_table *parse_seg_addr_table(char *file_name, char *flag,
                                                   char *argument,
                                                   uint32_t *table_size);
...
extern void process_seg_addr_table(
    char *file_name, FILE *out_fp, char *comment_prefix,
