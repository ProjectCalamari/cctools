...
get_arch_from_host(struct arch_flag *family_arch_flag,
  ...
  if ((r = host_info(my_mach_host_self, HOST_BASIC_INFO,
                     (host_info_t)(&host_basic_info), &count)) !=
      KERN_SUCCESS) {
    ...
    default:
      ...
      if (specific_arch_flag != NULL) {
        ...
        if (specific_arch_flag->name != NULL)
          sprintf(specific_arch_flag->name, "PowerPC cpusubtype %u",
  ...
  case CPU_TYPE_VEO:
    ...
    default:
      ...
      if (specific_arch_flag != NULL) {
        specific_arch_flag->name = savestr("VEO cpusubtype 1234567890");
        sprintf(specific_arch_flag->name, "VEO cpusubtype %u",
                host_basic_info.cpu_subtype);
      }
      return (1);
    }
  ...
  case CPU_TYPE_I386:
    ...
    default:
      ...
      if (specific_arch_flag != NULL) {
        specific_arch_flag->name = savestr("Intel family 12 model 12345678");
        if (specific_arch_flag->name != NULL)
          sprintf(specific_arch_flag->name, "Intel family %u model %u",
