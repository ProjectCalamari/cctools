...
void swap_i386_thread_state(i386_thread_state_t *cpu,
...
void swap_x86_thread_state64(x86_thread_state64_t *cpu,
                             enum NXByteOrder target_byte_sex) {
...
void swap_x86_state_hdr(x86_state_hdr_t *hdr,
                        enum NXByteOrder target_byte_sex) {
  hdr->flavor = OSSwapInt32(hdr->flavor);
  hdr->count = OSSwapInt32(hdr->count);
}

void swap_x86_float_state64(x86_float_state64_t *fpu,
                            enum NXByteOrder target_byte_sex) {
...
void swap_x86_exception_state64(x86_exception_state64_t *exc,
                                enum NXByteOrder target_byte_sex) {
...
void swap_x86_thread_state(x86_thread_state_t *cpu,
                           enum NXByteOrder target_byte_sex) {
  x86_state_hdr_t hdr;
  enum NXByteOrder host_byte_sex;
...
void swap_x86_float_state(x86_float_state_t *fpu,
                          enum NXByteOrder target_byte_sex) {
  x86_state_hdr_t hdr;
  enum NXByteOrder host_byte_sex;
...
void swap_x86_exception_state(x86_exception_state_t *exc,
                              enum NXByteOrder target_byte_sex) {
  x86_state_hdr_t hdr;
  enum NXByteOrder host_byte_sex;
...
void swap_x86_debug_state32(x86_debug_state32_t *debug,
                            enum NXByteOrder target_byte_sex) {
...
void swap_x86_debug_state64(x86_debug_state64_t *debug,
                            enum NXByteOrder target_byte_sex) {
...
void swap_x86_debug_state(x86_debug_state_t *debug,
                          enum NXByteOrder target_byte_sex) {
  x86_state_hdr_t hdr;
  enum NXByteOrder host_byte_sex;
...
/* current i386 thread states */
#if i386_THREAD_STATE == 1
void swap_i386_float_state(struct i386_float_state *fpu,
                           enum NXByteOrder target_byte_sex) {
...
#if i386_THREAD_STATE == -1
void swap_i386_thread_fpstate(i386_thread_fpstate_t *fpu,
                              enum NXByteOrder target_byte_sex) {
  struct swapped_fp_control {
    union {
      struct {
...
void swap_i386_thread_exceptstate(i386_thread_exceptstate_t *exc,
                                  enum NXByteOrder target_byte_sex) {
...
void swap_i386_thread_cthreadstate(i386_thread_cthreadstate_t *user,
                                   enum NXByteOrder target_byte_sex) {
