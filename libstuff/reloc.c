 ...
 */
__private_extern__ uint32_t reloc_pair_r_type(cpu_type_t cputype) {
  switch (cputype) {
 ...
 */
__private_extern__ enum bool reloc_has_pair(cpu_type_t cputype,
                                            uint32_t r_type) {
  switch (cputype) {
  case CPU_TYPE_MC680x0:
  case CPU_TYPE_I386:
 ...
 */
__private_extern__ enum bool reloc_is_sectdiff(cpu_type_t cputype,
                                               uint32_t r_type) {
  switch (cputype) {
  case CPU_TYPE_MC680x0:
  case CPU_TYPE_I386:
