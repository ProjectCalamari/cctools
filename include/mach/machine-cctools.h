...
#define CPU_SUBTYPE_ARM_V6M                                                    \
  ((cpu_subtype_t)14) /* Not meant to be run under xnu */
#define CPU_SUBTYPE_ARM_V7M                                                    \
  ((cpu_subtype_t)15) /* Not meant to be run under xnu */
#define CPU_SUBTYPE_ARM_V7EM                                                   \
  ((cpu_subtype_t)16) /* Not meant to be run under xnu */
#define CPU_SUBTYPE_ARM_V8M                                                    \
  ((cpu_subtype_t)17) /* Not meant to be run under xnu */
#define CPU_SUBTYPE_ARM_V8M_MAIN                                               \
  CPU_SUBTYPE_ARM_V8M /* Not meant to be run under xnu */
#define CPU_SUBTYPE_ARM_V8M_BASE                                               \
  ((cpu_subtype_t)18) /* Not meant to be run under xnu */
#define CPU_SUBTYPE_ARM_V8_1M_MAIN                                             \
  ((cpu_subtype_t)19) /* Not meant to be run under xnu */
