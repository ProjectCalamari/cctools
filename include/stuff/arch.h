 ...
 */
__private_extern__ int get_arch_from_flag(char *name,
 ...
 */
__private_extern__ int get_arch_from_host(struct arch_flag *family_arch_flag,
 ...
 */
__private_extern__ const struct arch_flag *get_arch_flags(void);
 ...
 */
__private_extern__ void arch_usage(void);
 ...
 * "error.h".
 */
__private_extern__ void set_arch_flag_name(struct arch_flag *p);
...
get_arch_name_from_types(cpu_type_t cputype, cpu_subtype_t cpusubtype);
 ...
 */
__private_extern__ const char *get_arch_name_if_known(cpu_type_t cputype,
                                                      cpu_subtype_t cpusubtype);
 ...
 */
__private_extern__ const struct arch_flag *
get_arch_family_from_cputype(cpu_type_t cputype);
 ...
 */
__private_extern__ enum byte_sex
get_byte_sex_from_flag(const struct arch_flag *flag);
...
get_stack_addr_from_flag(const struct arch_flag *flag);
...
get_segalign_from_flag(const struct arch_flag *flag);
 ...
 */
__private_extern__ uint32_t
get_shared_region_size_from_flag(const struct arch_flag *flag);
...
force_cpusubtype_ALL_for_cputype(cpu_type_t cputype);
