 ...
 * 'unsigned long'.
 */
extern char *getsectdata(const char *segname, const char *sectname,
                         unsigned long *size)
    __CCTOOLS_DEPRECATED_MSG("use getsectiondata()");

extern char *getsectdatafromFramework(const char *FrameworkName,
 ...
 */
extern const struct section *getsectbyname(const char *segname,
                                           const char *sectname)
    __CCTOOLS_DEPRECATED_MSG("use getsectiondata(&__dso_handle,)");

extern uint8_t *getsectiondata(const struct mach_header *mhp,
                               const char *segname, const char *sectname,
                               unsigned long *size);

extern const struct segment_command *
getsegbyname(const char *segname) __CCTOOLS_DEPRECATED;

extern uint8_t *getsegmentdata(const struct mach_header *mhp,
                               const char *segname, unsigned long *size);

#else /* defined(__LP64__) */
/*
 * Runtime interfaces for 64-bit Mach-O programs.
 */
extern const struct section_64 *getsectbyname(const char *segname,
                                              const char *sectname);
...
extern const struct segment_command_64 *
getsegbyname(const char *segname) __CCTOOLS_DEPRECATED;
 ...
 */
extern char *getsectdatafromheader(const struct mach_header *mhp,
                                   const char *segname, const char *sectname,
                                   uint32_t *size)
    __CCTOOLS_DEPRECATED_MSG("use getsectiondata()");
...
extern const struct section *
getsectbynamefromheaderwithswap(struct mach_header *mhp, const char *segname,
                                const char *sectname, int fSwap)
    __CCTOOLS_DEPRECATED_MSG("use getsectiondata()");

/*
 * Interfaces for tools working with 64-bit Mach-O files.
 */
extern char *getsectdatafromheader_64(const struct mach_header_64 *mhp,
                                      const char *segname, const char *sectname,
                                      uint64_t *size)
    __CCTOOLS_DEPRECATED_MSG("use getsectiondata()");

extern const struct section_64 *
getsectbynamefromheader_64(const struct mach_header_64 *mhp,
                           const char *segname, const char *sectname)
    __CCTOOLS_DEPRECATED_MSG("use getsectiondata()");

extern const struct section *getsectbynamefromheaderwithswap_64(
    struct mach_header_64 *mhp, const char *segname, const char *sectname,
