...
extern enum dyld_debug_return
_dyld_debug_defining_module(mach_port_t target_task, unsigned long send_timeout,
                            unsigned long rcv_timeout,
                            boolean_t inconsistent_data_ok, char *name,
                            struct dyld_debug_module *module);

extern enum dyld_debug_return
_dyld_debug_is_module_bound(mach_port_t target_task, unsigned long send_timeout,
                            unsigned long rcv_timeout,
                            boolean_t inconsistent_data_ok,
                            struct dyld_debug_module module, boolean_t *bound);

extern enum dyld_debug_return
_dyld_debug_bind_module(mach_port_t target_task, unsigned long send_timeout,
                        unsigned long rcv_timeout,
                        boolean_t inconsistent_data_ok,
                        struct dyld_debug_module module);

extern enum dyld_debug_return
_dyld_debug_module_name(mach_port_t target_task, unsigned long send_timeout,
                        unsigned long rcv_timeout,
                        boolean_t inconsistent_data_ok,
                        struct dyld_debug_module module, char **image_name,
                        unsigned long *image_nameCnt, char **module_name,
                        unsigned long *module_nameCnt);

extern enum dyld_debug_return _dyld_debug_subscribe_to_events(
    mach_port_t target_task, unsigned long send_timeout,
    unsigned long rcv_timeout, boolean_t inconsistent_data_ok,
 ...
 */
extern enum dyld_debug_return
_dyld_debug_make_runnable(mach_port_t target_task,
 ...
 */
extern enum dyld_debug_return
_dyld_debug_restore_runnable(mach_port_t target_task,
                             struct _dyld_debug_task_state *state);
...
extern void
_dyld_debug_set_error_func(void (*func)(struct dyld_debug_error_data *e));

#ifndef DYLD_BUILD /* do not include this when building dyld itself */

extern enum dyld_debug_return
_dyld_debug_task_from_core(NSObjectFileImage coreFileImage,
