...
#define VALID_THREAD_STATE_FLAVOR(x)                                           \
  ((x == x86_THREAD_STATE32) || (x == x86_FLOAT_STATE32) ||                    \
   (x == x86_EXCEPTION_STATE32) || (x == x86_DEBUG_STATE32) ||                 \
   (x == x86_THREAD_STATE64) || (x == x86_FLOAT_STATE64) ||                    \
   (x == x86_EXCEPTION_STATE64) || (x == x86_DEBUG_STATE64) ||                 \
   (x == x86_THREAD_STATE) || (x == x86_FLOAT_STATE) ||                        \
   (x == x86_EXCEPTION_STATE) || (x == x86_DEBUG_STATE) ||                     \
   (x == x86_AVX_STATE32) || (x == x86_AVX_STATE64) || (x == x86_AVX_STATE) || \
   (x == x86_AVX512_STATE32) || (x == x86_AVX512_STATE64) ||                   \
   (x == x86_AVX512_STATE) || (x == THREAD_STATE_NONE))
...
#define i386_THREAD_STATE_COUNT                                                \
  ((mach_msg_type_number_t)(sizeof(i386_thread_state_t) / sizeof(int)))

typedef _STRUCT_X86_THREAD_STATE32 x86_thread_state32_t;
#define x86_THREAD_STATE32_COUNT                                               \
...
#define i386_FLOAT_STATE_COUNT                                                 \
  ((mach_msg_type_number_t)(sizeof(i386_float_state_t) / sizeof(unsigned int)))

typedef _STRUCT_X86_FLOAT_STATE32 x86_float_state32_t;
#define x86_FLOAT_STATE32_COUNT                                                \
  ((mach_msg_type_number_t)(sizeof(x86_float_state32_t) / sizeof(unsigned int)))

typedef _STRUCT_X86_AVX_STATE32 x86_avx_state32_t;
#define x86_AVX_STATE32_COUNT                                                  \
  ((mach_msg_type_number_t)(sizeof(x86_avx_state32_t) / sizeof(unsigned int)))

typedef _STRUCT_X86_AVX512_STATE32 x86_avx512_state32_t;
#define x86_AVX512_STATE32_COUNT                                               \
  ((mach_msg_type_number_t)(sizeof(x86_avx512_state32_t) /                     \
                            sizeof(unsigned int)))
...
#define i386_EXCEPTION_STATE_COUNT                                             \
  ((mach_msg_type_number_t)(sizeof(i386_exception_state_t) / sizeof(int)))

typedef _STRUCT_X86_EXCEPTION_STATE32 x86_exception_state32_t;
#define x86_EXCEPTION_STATE32_COUNT                                            \
  ((mach_msg_type_number_t)(sizeof(x86_exception_state32_t) / sizeof(int)))

#define I386_EXCEPTION_STATE_COUNT i386_EXCEPTION_STATE_COUNT

typedef _STRUCT_X86_DEBUG_STATE32 x86_debug_state32_t;
#define x86_DEBUG_STATE32_COUNT                                                \
...
#define x86_AVX_STATE64_COUNT                                                  \
  ((mach_msg_type_number_t)(sizeof(x86_avx_state64_t) / sizeof(unsigned int)))

typedef _STRUCT_X86_AVX512_STATE64 x86_avx512_state64_t;
#define x86_AVX512_STATE64_COUNT                                               \
  ((mach_msg_type_number_t)(sizeof(x86_avx512_state64_t) /                     \
                            sizeof(unsigned int)))
...
#define x86_DEBUG_STATE64_COUNT                                                \
...
#define x86_FLOAT_STATE_COUNT                                                  \
  ((mach_msg_type_number_t)(sizeof(x86_float_state_t) / sizeof(unsigned int)))

typedef struct x86_exception_state x86_exception_state_t;
#define x86_EXCEPTION_STATE_COUNT                                              \
  ((mach_msg_type_number_t)(sizeof(x86_exception_state_t) /                    \
                            sizeof(unsigned int)))

typedef struct x86_debug_state x86_debug_state_t;
#define x86_DEBUG_STATE_COUNT                                                  \
  ((mach_msg_type_number_t)(sizeof(x86_debug_state_t) / sizeof(unsigned int)))

typedef struct x86_avx_state x86_avx_state_t;
#define x86_AVX_STATE_COUNT                                                    \
  ((mach_msg_type_number_t)(sizeof(x86_avx_state_t) / sizeof(unsigned int)))

typedef struct x86_avx512_state x86_avx512_state_t;
#define x86_AVX512_STATE_COUNT                                                 \
  ((mach_msg_type_number_t)(sizeof(x86_avx512_state_t) / sizeof(unsigned int)))
...
#define x86_SAVED_STATE32_COUNT                                                \
  ((mach_msg_type_number_t)(sizeof(x86_saved_state32_t) / sizeof(unsigned int)))
...
#define x86_SAVED_STATE64_COUNT                                                \
  ((mach_msg_type_number_t)(sizeof(struct x86_saved_state64) /                 \
                            sizeof(unsigned int)))
...
static inline boolean_t is_saved_state64(x86_saved_state_t *iss) {
  return (iss->flavor == x86_SAVED_STATE64);
}

static inline boolean_t is_saved_state32(x86_saved_state_t *iss) {
  return (iss->flavor == x86_SAVED_STATE32);
}

static inline x86_saved_state32_t *saved_state32(x86_saved_state_t *iss) {
  return &iss->ss_32;
}

static inline x86_saved_state64_t *saved_state64(x86_saved_state_t *iss) {
  return &iss->ss_64;
}
