...
struct literal_pointer_bucket {
  struct literal_pointer *literal_pointer; /* pointer to the literal pointer */
  unsigned long output_offset; /* offset to this pointer in the output file */
  struct literal_pointer_bucket *next; /* next in the hash chain */
};
...
struct literal_pointer_block {
  ...
  struct literal_pointer /*  this block */
      literal_pointers[LITERAL_POINTER_BLOCK_SIZE]; /* the literal pointers */
...
__private_extern__ void literal_pointer_free(struct literal_pointer_data *data);

#ifdef DEBUG
__private_extern__ void
print_literal_pointer_data(struct literal_pointer_data *data, char *ident);
__private_extern__ void
