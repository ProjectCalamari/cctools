...
#endif
    const char *file_name, const struct arch_flag *arch_flag, /* can be NULL */
...
#endif
    char *addr, uint64_t size, const char *file_name, uint64_t mtime,
...
__private_extern__ enum bool ofile_specific_member(const char *object_name,
                                                   struct ofile *ofile);
...
ofile_get_word(uint64_t addr, uint32_t *word,
               void *get_word_data /* struct ofile *ofile */);
__private_extern__ void archive_error(struct ofile *ofile, const char *format,
                                      ...)
#ifndef __MWERKS__
    __attribute__((format(printf, 2, 3)))
#endif
    ;
__private_extern__ void archive_member_error(struct ofile *ofile,
                                             const char *format, ...)
#ifndef __MWERKS__
    __attribute__((format(printf, 2, 3)))
#endif
    ;
__private_extern__ void Mach_O_error(struct ofile *ofile, const char *format,
                                     ...)
#ifndef __MWERKS__
    __attribute__((format(printf, 2, 3)))
#endif
...
#ifdef LTO_SUPPORT
__private_extern__ int is_llvm_bitcode(struct ofile *ofile, char *addr,
                                       size_t size);
#endif /* LTO_SUPPORT */
