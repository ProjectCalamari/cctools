...
static int cmp_qsort_name(const struct symbol_list *sym1,
 ...
 */
__private_extern__ void setup_symbol_list(char *file, struct symbol_list **list,
                                          uint32_t *size) {
  int fd;
  ...
  *list = (struct symbol_list *)allocate((*size) * sizeof(struct symbol_list));
 ...
 */
__private_extern__ int symbol_list_bsearch(const char *name,
