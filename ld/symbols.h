...
struct merged_symbol {
  ...
  unsigned long error_flagged_for_dylib
      : 1,                            /* symbol reported as an error in dylib */
...
struct undefined_list {
  struct merged_symbol *merged_symbol; /* the undefined symbol */
...
struct common_load_map {
  ...
  unsigned long ncommon_symbols; /* number of common symbols */
...
__private_extern__ struct merged_symbol *command_line_symbol(char *symbol_name);
...
__private_extern__ void free_pass1_symbol_data(void);
