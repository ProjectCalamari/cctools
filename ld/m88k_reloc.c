 ...
 */
__private_extern__ void m88k_reloc(char *contents,
    ...
    if (r_extern) {
      ...
      if (r_symbolnum != R_ABS) {
        ...
        if (local_map->nfine_relocs == 0 &&
           ...
           * relocated.
           */
          if (r_type == M88K_RELOC_VANILLA || r_type == M88K_RELOC_SECTDIFF) {
            switch (r_length) {
            case 0: /* byte */
            ...
            case M88K_RELOC_PC26:
              if ((value & 0xf8000000) != 0xf8000000 &&
                ...
                error_with_cur_obj("relocation overflow "
                                   ...
                                   section_map->s->sectname);
              value >>= 2;
              instruction = (instruction & 0xfc000000) | (value & 0x03ffffff);
              break;
            default:
      ...
      case M88K_RELOC_PC26:
        ...
        if ((immediate & 0xf8000000) != 0xf8000000 &&
          ...
          error_with_cur_obj("relocation overflow for relocation "
                             ...
                             section_map->s->sectname);
        immediate >>= 2;
        instruction = (instruction & 0xfc000000) | (immediate & 0x03ffffff);
        break;
      default:
