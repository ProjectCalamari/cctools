...
#define MH_FILESET                                                             \
  0xc                      /* a file composed of other Mach-Os to              \
...
#define MH_IMPLICIT_PAGEZERO                                                   \
  0x10000000 /* main executable has no __PAGEZERO                              \
...
#define S_THREAD_LOCAL_INIT_FUNCTION_POINTERS                                  \
  0x15 /* functions to call                                                    \
          to initialize TLV                                                    \
          values */
#define S_INIT_FUNC_OFFSETS                                                    \
  0x16 /* 32-bit offsets to                                                    \
          initializers */
