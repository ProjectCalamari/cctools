...
struct merged_section {
  ...
  struct order_load_map     /* the load map for printing with -M */
      *order_load_maps;
  unsigned long norder_load_maps; /* size of the above map */
#ifdef RLD
...
struct order_load_map {
  ...
  struct section_map *section_map; /* section map to relocate symbol's value */
...
__private_extern__ struct merged_section *lookup_merged_section(char *segname,
                                                                char *sectname);
__private_extern__ enum bool
