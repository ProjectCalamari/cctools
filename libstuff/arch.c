 ...
 */
__private_extern__ const char *
get_arch_name_if_known(cpu_type_t cputype, cpu_subtype_t cpusubtype) {
  uint32_t i;
 ...
 */
static void abort_with_unknown_cputype(cpu_type_t cputype) { abort(); }

/*
 * get_cpu_entry_from_cputype() for the specified cputype. If unknown it
 * calls abort_with_unknown_cputype().
 */
static const struct cpu_entry *get_cpu_entry_from_cputype(cpu_type_t cputype) {
