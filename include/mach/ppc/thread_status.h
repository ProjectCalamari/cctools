...
#define PPC_THREAD_STATE_COUNT                                                 \
  ((mach_msg_type_number_t)(sizeof(ppc_thread_state_t) / sizeof(int)))

#define PPC_THREAD_STATE64_COUNT                                               \
  ((mach_msg_type_number_t)(sizeof(ppc_thread_state64_t) / sizeof(int)))

#define PPC_EXCEPTION_STATE_COUNT                                              \
  ((mach_msg_type_number_t)(sizeof(ppc_exception_state_t) / sizeof(int)))

#define PPC_EXCEPTION_STATE64_COUNT                                            \
  ((mach_msg_type_number_t)(sizeof(ppc_exception_state64_t) / sizeof(int)))

#define PPC_FLOAT_STATE_COUNT                                                  \
  ((mach_msg_type_number_t)(sizeof(ppc_float_state_t) / sizeof(int)))

#define PPC_VECTOR_STATE_COUNT                                                 \
  ((mach_msg_type_number_t)(sizeof(ppc_vector_state_t) / sizeof(int)))
