...
struct merged_dylinker {
  ...
  struct dylinker_command *dyld; /* The load command for the dynamicly linker */
  struct object_file             /* Pointer to the object file the load */
      *definition_object;        /*  command was found in */
};
...
struct merged_sub_frameworks {
  ...
  struct sub_framework_command *sub; /* The load command for the output file */
};
...
struct merged_sub_umbrella {
  struct sub_umbrella_command *sub; /* The load command for the output file */
};
...
struct merged_sub_library {
  struct sub_library_command *sub; /* The load command for the output file */
};
...
struct merged_sub_client {
  struct sub_client_command *sub; /* The load command for the output file */
};
